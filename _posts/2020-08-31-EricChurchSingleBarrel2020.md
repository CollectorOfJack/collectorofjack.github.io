...
featured_image: 32/EricChurchSingleBarrel2020-1.jpg
description: The 2020 Release of the Limited Edition Jack Daniel's Eric Church Single Barrel Select
---

In July/August 2020 Jack Daniel's released the 2020 version of the Eric Church Single Barrel Select bottle, a follow on release after their [2019 Eric Church Double Down Tour Single Barre](https://collectorofjack.com/JackDanielsEricChurch). This year's bottle is a beautiful opaque black with a black and gold label. It came with a paper hang tag, also in black and gold.
...
### The Hunt
The Eric Church Single Barrel release was a hard find bottle in 2020, selling very quickly where available. On Wednesday July 29th I was able to track down a bottle in Texas which I ordered and had a family member pick up. That order is still sitting in my cousin's house in Texas until we can find a time to meet up post covid. 
...
<div class="gallery" data-columns="3">     
    {% picture 32/EricChurchSingleBarrel2020-1.jpg --alt {{ page.title }}  %}
    {% picture 32/EricChurchSingleBarrel2020-2.jpg --alt {{ page.title }}  %}
    {% picture 32/EricChurchSingleBarrel2020-3.jpg --alt {{ page.title }}  %}
    {% picture 32/EricChurchSingleBarrel2020-4.jpg --alt {{ page.title }}  %}
    {% picture 32/EricChurchSingleBarrel2020-5.jpg --alt {{ page.title }}  %}
    {% picture 32/EricChurchSingleBarrel2020-6.jpg --alt {{ page.title }}  %}
    {% picture 32/EricChurchSingleBarrel2020-7.jpg --alt {{ page.title }}  %}
</div>
