...
<div class="gallery" data-columns="3">     
    {% picture 42/BarrelTree-1.jpg --alt {{ page.title }}  %}
    {% picture 42/BarrelTree-2.jpg --alt First full barrels with supports  %}
    {% picture 42/BarrelTree-3.jpg --alt Failed print of 9 barrels %}
    {% picture 42/BarrelTree-4.jpg --alt 4 barrels inside of a barrel bottom that I stopped printing  %}
    {% picture 42/BarrelTree-5.jpg --alt 3 of 4 barrels stained  %}
    {% picture 42/BarrelTree-6.jpg --alt 6 bottomless barrels  %}
    {% picture 42/BarrelTree-7.jpg --alt Testing tree configurations some pre-stain %}
</div>