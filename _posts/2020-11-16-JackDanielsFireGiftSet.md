...
featured_image: 38/JackDanielsFireShotGlassSet-1.jpg
...
<div class="gallery" data-columns="3">     
    {% picture 38/JackDanielsFireShotGlassSet-1.jpg --alt {{ page.title }}  %}
    {% picture 38/JackDanielsFireShotGlassSet-2.jpg --alt {{ page.title }}  %}
    {% picture 38/JackDanielsFireShotGlassSet-3.jpg --alt {{ page.title }}  %}
    {% picture 38/JackDanielsFireShotGlassSet-4.jpg --alt {{ page.title }}  %}
</div>