...
<div class="gallery" data-columns="3">     
    {% picture 35/JackDanielsFire2020-1.jpg --alt {{ page.title }}  %}
    {% picture 35/JackDanielsFire2020-2.jpg --alt {{ page.title }}  %}
    {% picture 35/JackDanielsFire2020-3.jpg --alt {{ page.title }}  %}
    {% picture 35/JackDanielsFire2020-4.jpg --alt {{ page.title }}  %}
</div>