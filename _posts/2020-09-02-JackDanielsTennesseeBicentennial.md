...
featured_image: 33/JackDanielsBicentennial-1.jpg
...
<div class="gallery" data-columns="3">     
    {% picture 33/JackDanielsBicentennial-1.jpg --alt {{ page.title }}  %}
    {% picture 33/JackDanielsBicentennial-2.jpg --alt {{ page.title }}  %}
    {% picture 33/JackDanielsBicentennial-3.jpg --alt {{ page.title }}  %}
    {% picture 33/JackDanielsBicentennial-4.jpg --alt {{ page.title }}  %}
    {% picture 33/JackDanielsBicentennial-5.jpg --alt {{ page.title }}  %}
    {% picture 33/JackDanielsBicentennial-6.jpg --alt {{ page.title }}  %}
    {% picture 33/JackDanielsBicentennial-7.jpg --alt {{ page.title }}  %}
</div>