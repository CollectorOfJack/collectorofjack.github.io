...
<div class="gallery" data-columns="3">     
    {% picture 46/ScenesOfLynchburg5-1.jpg --alt {{ page.title }}  %}
    {% picture 46/ScenesOfLynchburg5-3.jpg --alt {{ page.title }}  %}
    {% picture 46/ScenesOfLynchburg5-4.jpg --alt {{ page.title }}  %}
</div>